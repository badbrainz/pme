...
void PveObject::ReadVertexChunk(void)
{
  ...
  m_pCompressedYBuffer = new unsigned char[(m_uiTilesPerX*2+1) * (m_uiTilesPerY*2+1)];
...
void PveObject::ReadColorChunk(void)
{
  ...
  m_pColorBuffer = new Tuple4ub[(m_uiTilesPerX*2+1) * (m_uiTilesPerY*2+1)];
...
void PveObject::ReadTileChunk(void)
{
  ...
  m_pTileSet = new Tile[m_uiTilesPerX * m_uiTilesPerY];
