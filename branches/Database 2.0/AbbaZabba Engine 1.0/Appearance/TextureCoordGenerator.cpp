...
void TextureCoordGenerator::setMode(const char* modeArg)
{
  ...
  if(!strcmp(modeArg, "REFLECTION_MAP")){ mode = GL_REFLECTION_MAP; return; }
  if(!strcmp(modeArg, "OBJECT_LINEAR")) { mode = GL_OBJECT_LINEAR;  return; }
  if(!strcmp(modeArg, "EYE_LINEAR"))    { mode = GL_EYE_LINEAR;     return; }
  if(!strcmp(modeArg, "NORMAL_MAP"))    { mode = GL_NORMAL_MAP;     return; }
  if(!strcmp(modeArg, "SPHERE_MAP"))    { mode = GL_SPHERE_MAP;     return; }
