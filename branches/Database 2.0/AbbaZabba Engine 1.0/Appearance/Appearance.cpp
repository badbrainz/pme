...
void  Appearance::setColor(const float* c){ color.set(c[0], c[1], c[2], c[3]);      }
void  Appearance::setColor(float r, float g, float b, float a){ color.set(r,g,b,a); }
const Tuple4f &Appearance::getColor() const { return color; }

void     Appearance::setShaders(Shaders &shadersArg){ shaders = shadersArg; }
Shaders &Appearance::getShaders()                   { return shaders;       }
