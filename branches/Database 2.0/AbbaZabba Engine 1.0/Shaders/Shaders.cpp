...
bool Shaders::loadXMLSettings(const char * xmlFile, 
                                   ...
                                   int               shaderType)
{
  ...
  switch(shaderType)
  {
    ...
    break;
    default: return Logger::writeErrorLog("Unknown or supported shader type");
  }
  ...
  for(size_t c = 0; c < node->getChildrenCount(); c++)
  {
    ...
    if(name == "Uniform" )
    {
      ...
      if(floatUniform)
      {
        ...
        switch(uniformSize)
        {
          case 1:  shader->addAttributes1f(ShaderElements1f(name, floatUniforms));
          break;
          case 2:  shader->addAttributes2f(ShaderElements2f(name, floatUniforms));
          break;
          case 3:  shader->addAttributes3f(ShaderElements3f(name, floatUniforms));
          break;
          case 4:  shader->addAttributes4f(ShaderElements4f(name, floatUniforms));
          break;
          case 16: shader->addAttributes16f(ShaderElements16f(name, NULL));
          break;
          default: Logger::writeErrorLog("Size of shader's uniform unspecified or not valid");
        }
      }
      else
      {
        ...
        switch(uniformSize)
        {
          case 1:  shader->addAttributes1i(ShaderElements1i(name, intUniforms));
          break;
          case 2:  shader->addAttributes2i(ShaderElements2i(name, intUniforms));
          break;
          case 3:  shader->addAttributes3i(ShaderElements3i(name, intUniforms));
          break;
          case 4:  shader->addAttributes4i(ShaderElements4i(name, intUniforms));
          break;
          default: return Logger::writeErrorLog("Size of shader's uniform unspecified");
        }
      }
    }
  }
...
ShaderAttributes *Shaders::getLinkedProcessor()  { return linkedProcessor;   }
ShaderAttributes &Shaders::getVertexProcessor()  { return vertexProcessor;   }
ShaderAttributes &Shaders::getFragmentProcessor(){ return fragmentProcessor; }