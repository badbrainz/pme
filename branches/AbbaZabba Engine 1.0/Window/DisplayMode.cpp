...
void DisplayMode::setColorDepth(int colorDepthArg){ colorDepth  = colorDepthArg; }
int  DisplayMode::getColorDepth()                 { return colorDepth;           }

void DisplayMode::setHeight(int heightArg){ height  = clamp(heightArg, 1, 2048); }
int  DisplayMode::getHeight()             { return height;                      }

void DisplayMode::setWidth(int widthArg){ width  = clamp(widthArg, 1, 2048); }
int  DisplayMode::getWidth()            { return width;                     }
...
void DisplayMode::setXPosition(int x_){ x  = fullscreen ? 0 : x_; }
void DisplayMode::setYPosition(int y_){ y  = fullscreen ? 0 : y_; }

int  DisplayMode::getXPosition(){ return x; }
int  DisplayMode::getYPosition(){ return y; }

void DisplayMode::setFullscreen(bool fs){ fullscreen = fs; setCentered(centered); }
bool DisplayMode::isFullscreen()        { return fullscreen;                      }

void DisplayMode::setCentered(bool cen){ centered   = fullscreen ? false : cen; }
bool DisplayMode::isCentered()         { return centered;                       }