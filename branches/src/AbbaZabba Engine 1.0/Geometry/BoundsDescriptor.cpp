...
const void BoundsDescriptor::render(int info)  const
{
  if(info & OBB)
  {
    ...
    else
    {
      ...
      glVertex3fv(verticesOBB[3]); glVertex3fv(verticesOBB[0]);
      glVertex3fv(verticesOBB[1]); glVertex3fv(verticesOBB[2]);
      glVertex3fv(verticesOBB[3]); glVertex3fv(verticesOBB[7]);
      glVertex3fv(verticesOBB[6]); glVertex3fv(verticesOBB[5]);
      glVertex3fv(verticesOBB[4]); glVertex3fv(verticesOBB[7]);
      glEnd();

      glBegin(GL_LINES);
      glVertex3fv(verticesOBB[0]); glVertex3fv(verticesOBB[4]);
      glVertex3fv(verticesOBB[1]); glVertex3fv(verticesOBB[5]);
      glVertex3fv(verticesOBB[2]); glVertex3fv(verticesOBB[6]);
      glEnd();
    }
  }
  else
  {
    glBegin(GL_LINES);
    glVertex3fv(minEndAABB); glVertex3f(maxEndAABB.x, minEndAABB.y, minEndAABB.z);
    glVertex3fv(minEndAABB); glVertex3f(minEndAABB.x, maxEndAABB.y, minEndAABB.z);
    glVertex3fv(minEndAABB); glVertex3f(minEndAABB.x, minEndAABB.y, maxEndAABB.z);

    glVertex3fv(maxEndAABB); glVertex3f(minEndAABB.x, maxEndAABB.y, maxEndAABB.z);
    glVertex3fv(maxEndAABB); glVertex3f(maxEndAABB.x, maxEndAABB.y, minEndAABB.z);
    glVertex3fv(maxEndAABB); glVertex3f(maxEndAABB.x, minEndAABB.y, maxEndAABB.z);
...
const Tuple3f &BoundsDescriptor::getMinEndAABB() const { return minEndAABB; }
const Tuple3f &BoundsDescriptor::getMaxEndAABB() const { return maxEndAABB; }
const Tuple3f &BoundsDescriptor::getCenterAABB() const { return centerAABB; }
const Tuple3f &BoundsDescriptor::getCenterOBB()  const { return centerOBB;  }
const Tuple3f &BoundsDescriptor::getExtents()    const { return extents;    }
