...
const  GLuint ShaderAttributes::getShaderTrueType()
{
  switch(shaderType)
  {
    case VERTEX_PROGRAM:       return GL_VERTEX_PROGRAM_ARB;   break;
    case FRAGMENT_PROGRAM:     return GL_FRAGMENT_PROGRAM_ARB; break;
    case VERTEX_SHADER:   return GL_VERTEX_SHADER_ARB;    break;
    case FRAGMENT_SHADER: return GL_FRAGMENT_SHADER_ARB;  break;
    case LINKED_SHADER:   return GL_FRAGMENT_SHADER_ARB;  break;
  }
  return 0;
}
...
void ShaderAttributes::sendAttributes()
{
  ...
  {
    sendAttributes1f();  sendAttributes1i();
    sendAttributes2f();  sendAttributes2i();
    sendAttributes3f();  sendAttributes3i();
    sendAttributes4f();  sendAttributes4i();
    sendAttributes16f();
  }
